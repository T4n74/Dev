			...
			<div class="site-top-bar-right">
				...
				<?php if ( !get_theme_mod( 'nikkon-header-remove-no' ) ) : ?>
					<?php if ( get_theme_mod( 'nikkon-website-head-no' ) ) : ?>
						<span class="site-topbar-right-no"><?php echo ( get_theme_mod( 'nikkon-website-head-no-icon' ) ) ? '<i class="fa ' . sanitize_html_class( get_theme_mod( 'nikkon-website-head-no-icon' ) ) . '"></i> ' : ''; ?><?php echo wp_kses_post( get_theme_mod( 'nikkon-website-head-no' ) ) ?></span>
					<?php endif; ?>
				<?php endif; ?>
