...
<?php
    if(!empty($_POST)){
   	 ...
   	 if($valid){
     	...
     	$sujet = $nom. $prenom. " a envoyer un message sur le site pour une demande de:" .	$service;
...
*/        color: white; /* msg erreur quand champs vide*/
    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
        <p class="flotte">
            <a href="index.php#presentation"><img src="images/output-onlinepngtools.png" alt="nemoxia"></a>
        </p>
