...
<?php
    ...
    if($valid){
        ...
        $to = "opheliee_x@live.fr"; //  adresse destinataire
        $sujet = $nom. " a envoyer un message sur le site pour une demande :" .$service;
        ...
        $header .= "Reply-To: $email";  // ainsi quand on fait repondre sa selectionne l'@mail de l'utilisateur
...
*/        color: white; /* msg erreur quand champs vide*/
    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
        <p class="flotte">
            <a href="index.php#main-image"><img src="images/output-onlinepngtools.png" alt="nemoxia"></a>
        </p>
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="#possibilities">Outil</a></li>
...
<br><br>
        ...
        <footer>
            <div>
                <h1>NEMOXIA<br><img src="images/output-onlinepngtools.png" alt="nemoxia"></h1>
