...
function customizer_library_nikkon_options() {
    ...
    $options['nikkon-note-layout'] = array(
        ...
        'section' => $section,
        'type'    => 'upsell',
        'description' => __( '<big>See <a href="https://kairaweb.com/documentation/setup-home-blocks-like-the-nikkon-demo-website/" target="_blank">Demo Setup Instructions here</a></big><br /><br /><b>Premium Extra Features:</b><br />- Setting to change Sidebar width<br />- Enable Blocks layout on any/all pages<br />- Page featured image + layout settings<br /><br />- Set Shop, Archive & Single pages to Left Sidebar<br />- Set Shop, Archive & Single pages to full width<br />- Set WooCommerce products per page<br />- Set WooCommerce products per row<br />- Remove Products border', 'nikkon' )
    );
    ...
    $options['nikkon-note-header'] = array(
        ...
        'section' => $section,
        'type'    => 'upsell',
        'description' => __( '<b>Premium Extra Features:</b><br />- Add/Enable WooCommerce drop down cart/basket<br />- Extra "Split Nav" header layout<br />- Remove WooCommerce cart<br />- Add WooCommerce cart to header top bar<br />- Remove all header lines', 'nikkon' )
    );
    ...
    $sections[] = array(
        ...
        'priority' => '120',
        'description' => __( 'Nikkon adds/removes custom styling to support external plugins', 'nikkon' )
    );
